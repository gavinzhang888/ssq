  ...
  angular.module('willPaginate').run([
    ...
    return {
      ...
      link: function ($scope) {
        ...
        $scope.$watch('params.totalPages', function (newVal) {
          if (typeof newVal === 'undefined') {
            return;
          }
          $scope.render();
